...
using EldigmPlusSvc_Main.Biz.Sys.SysCode;
using System;
...
namespace EldigmPlusSvc_Main.WebSvc.Sys.SysCode
{
    ...
    public class WsSysCodeGrp : IWsSysCodeGrp
    {
        ...
        public string exSysCodeGrp(string pScodeGrp, out string reMsg, out string reData)
        {
            string reCode = "N";
            reData = "0";
            ...
            try
            {
                ...
                int reCnt = bizSys.exSysCodeGrp(pScodeGrp);
            ...
            {
                logs.SaveLog("[error]  (page)::WsSysCodeGrp.svc  (Function)::exSysCodeGrp  (Detail)::" + "\r\n" + ex.ToString(), "Error");
                reMsg = "[검색 에러] :: " + ex.ToString();
                reCode = "N";
            }
        ...
        public string aSysCodeGrp(string pScodeGrp, string pScodeGrpNm, string pUsingFlag, string pSortNo, string pMemo, string pInputId, out string reMsg, out string reData)
        {
            string reCode = "N";
            reData = "";
            ...
            try
            {
                ...
                int reCnt = bizSys.aSysCodeGrp(pScodeGrp, pScodeGrpNm, pUsingFlag, pSortNo, pMemo, pInputId);
            ...
            {
                logs.SaveLog("[error]  (page)::WsSysCodeGrp.svc  (Function)::aSysCodeGrp  (Detail)::" + "\r\n" + ex.ToString(), "Error");
                reMsg = "[저장 에러] :: " + ex.ToString();
                reCode = "N";
            }
        ...
        public string mSysCode(string pScode, string pScodeNm, string pUsingFlag, string pSortNo, string pMemo, string pInputId, out string reMsg, out string reData)
        {
            string reCode = "N";
            reData = "";
